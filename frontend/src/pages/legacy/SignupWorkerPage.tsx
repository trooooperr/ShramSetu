    ...
    <div x-data="{ open: false }">
        <nav class="bg-[#cceaff] shadow-md fixed top-0 left-0 right-0 z-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-4">
                    ...
                    <div class="hidden lg:flex items-center space-x-6">
                        <a href="/#whyShramSetu" class="text-gray-700 font-semibold hover:text-blue-600">Why
                            ShramSetu</a>
                        <a href="/howToWork" class="text-gray-700 font-semibold hover:text-blue-600">Find Work</a>
            ...
            <div x-show="open" x-transition x-cloak @click.away="open = false"
                ...
                <a href="/howToWork" class="flex items-center gap-2 p-2 rounded-xl hover:bg-indigo-100 shadow">
...
<main class="pt-24 pb-16 px-4 sm:px-6 lg:px-8 min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat bg-fixed overflow-hidden" style="background-image: url('/legacy/images/carousel/mainbg.png');">
        <div x-data="workerProfileForm()" x-init="initForm()"
            ...
            <div
                ...
                <div x-data="{
                    images: [
                        '/legacy/images/carousel/worker.1.png',
                        '/legacy/images/carousel/worker.2.png',
                        '/legacy/images/carousel/worker.3.png',
                        '/legacy/images/carousel/worker.4.png',
                        '/legacy/images/carousel/worker.5.png',
                    ],
                    currentIndex: 0,
    ...
    <div class="lg:p-8 p-4 h-full flex flex-col justify-between relative overflow-hidden bg-cover rounded-xl lg:rounded-none bg-center bg-no-repeat" style="background-image: url('/legacy/images/carousel/workerbg.png');">
    
   <form action="/signup_worker" method="POST" enctype="multipart/form-data" class="space-y-6 flex-grow max-h-full overflow-y-auto">
                    ...
                    <section x-show="currentStep === 1"
                        ...
                        <div class="grid md:grid-cols-2 gap-4 items-start">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" id="name" name="name" x-model="formData.fullName"
                        ...
                        <div>
                            ...
                            <textarea name="intro" id="shortBio"  rows="2" x-model="formData.shortBio"
                    ...
                    <section x-show="currentStep === 2"
                        ...
                        <div class="grid md:grid-cols-2 gap-4 items-start">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-2">
                                    <input type="tel" id="servicePincode"
                        ...
                        <div x-data="{
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="hidden" name="job" x-model="formData.workerSkills">
                        ...
                        <div class="grid md:grid-cols-2 gap-4 items-start">
                            <div>
                                ...
                                <input type="tel" id="contactPhone" name="mobile"
                    ...
                    <section x-show="currentStep === 3"
                                    ...
                                    <div class="relative">
                                        ...
                                        <ul x-show="openStart" @click.outside="openStart = false"
                                            ...
                                            <template x-for="time in timeSlots" :key="time">
                                                <li @click="selectTime('start', time); $root.validateStep(3);"
                                                    class="px-4 py-2 hover:bg-blue-100 cursor-pointer text-blue-900">
                                                    <span x-text="time"></span>
                                                </li>
                                            </template>
                                        </ul>
                                        <input type="hidden" name="doNotDisturbStart" x-model="$root.formData.dndStartTime">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="relative">
                                        ...
                                        <ul x-show="openEnd" @click.outside="openEnd = false"
                                            class="absolute z-30 mt-1 w-full bg-white border border-blue-200 rounded-md shadow-lg max-h-60 overflow-y-auto">
                                            <template x-for="time in timeSlots" :key="time">
                                                <li @click="selectTime('end', time); $root.validateStep(3);"
                                                    class="px-4 py-2 hover:bg-blue-100 cursor-pointer text-blue-900">
                                                    <span x-text="time"></span>
                                                </li>
                                            </template>
                                        </ul>
                                        <input type="hidden" name="doNotDisturbEnd" x-model="$root.formData.dndEndTime">
                        ...
                        <div class="form-group bg-blue-50 border border-blue-200 p-4 rounded-md shadow-sm">
                            ...
                            <input type="number" id="minPayExpectation" name="minimumpay"
                    ...
                    <section x-show="currentStep === 4"
                        ...
                        <div class="grid md:grid-cols-2 gap-4 items-start mt-4">
                            <div>
                                ...
                                <input type="text" id="bankAccountNumber" name="BankAccountNo"
                            ...
                            <div>
                                ...
                                <input type="text" id="ifscCode" name="ifsc" x-model="formData.ifscCode"
                    ...
                    <section x-show="currentStep === 5"
                        ...
                        <div class="form-group border border-dashed border-gray-300 p-4 rounded-md bg-blue-50/20">
                            ...
                            <input type="file" id="identityDocument" name="identity"
                    ...
                    <section x-show="currentStep === 6"
                        ...
                        <div class="space-y-3 text-gray-700 bg-blue-50 p-4 rounded-md">
                            ...
                            <div>
                                ...
                                <p x-text="(formData.dndStartTime || 'Not Set') + ' to ' + (formData.dndEndTime || 'Not Set')"></p>
                            </div>
                            <div>
        ...
        function workerProfileForm() {
            return {
                ...
                handleIdentityDocumentUpload(event) {
                    const validTypes = ['image/jpeg', 'image/png', 'application/pdf'];  // 🔥 ADD THIS
                ...
                validateStep(step) {
                    ...
                    if (step === 1) { // Personal Details
                        ...
                        if (this.formData.dndStartTime && !this.formData.dndEndTime) {
                            this.validationErrors.dndEndTime = 'Please select End Time.';
                            isValid = false;
                        }

                        if (!this.formData.dndStartTime && this.formData.dndEndTime) {
                            this.validationErrors.dndStartTime = 'Please select Start Time.';
                            isValid = false;
                        }
                ...
                nextStep(stepToValidate) {
                    const step = stepToValidate || this.currentStep;
                    ...
                    if (ok) {
                        ...
                        console.warn("Validation failed for step", step, this.validationErrors);
            ...
            return {
                ...
                selectTime(type, time) {
                    if (type === 'start') {
                        ...
                        this.$root.formData.dndStartTime = time;
                        this.openStart = false;
                    } else {
                        this.selectedEnd = time;
                        this.$root.formData.dndEndTime = time;
                        this.openEnd = false;
                    }
                    this.$root.validateStep(3);
                }
            }
        }
    </script>
