      ...
      theme: {
        extend: {
          ...
          boxShadow: {
            ...
            cardHover: '0 8px 24px rgba(21, 101, 192, 0.25)'
          },
          fontSize: {
            basePlus: '1.05rem'
          }
...
<section class="pt-28 bg-gradient-to-r from-blue-800 to-blue-600 py-12 shadow-md text-center">
  <div class="max-w-3xl mx-auto px-4" data-aos="fade">
    <h1 class="text-4xl font-extrabold mb-3 text-blue-100">How to Hire a ShramSevik</h1>
    <p class="text-lg font-medium leading-relaxed text-blue-200">
      A step-by-step guide to help you find the right skilled workers easily, securely, and quickly on ShramSetu.
    </p>
  </div>
</section>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition duration-300 p-6 flex flex-col justify-between h-[230px]" data-aos="fade-up">
        <div class="flex items-center gap-4 mb-4">
          ...
          <h2 class="text-xl font-bold text-primary">1. Create Account</h2>
        </div>
        <div class="text-[17px] text-gray-700 space-y-1 pl-2">
          <p>Sign up using phone or email easily.</p>
          <p>Complete your basic profile details.</p>
        </div>
        <p class="text-sm italic text-primary font-semibold text-right mt-4">Get started easily.</p>
      </div>
      ...
      <div class="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition duration-300 p-6 flex flex-col justify-between h-[230px]" data-aos="fade-up" data-aos-delay="100">
        <div class="flex items-center gap-4 mb-4">
          ...
          <h2 class="text-xl font-bold text-primary">2. Post Job</h2>
        </div>
        <div class="text-[17px] text-gray-700 space-y-1 pl-2">
          <p>Select category, add job description.</p>
          <p>Mention location and estimated pay.</p>
        </div>
        <p class="text-sm italic text-primary font-semibold text-right mt-4">Be clear with details.</p>
      </div>
      ...
      <div class="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition duration-300 p-6 flex flex-col justify-between h-[230px]" data-aos="fade-up" data-aos-delay="200">
        <div class="flex items-center gap-4 mb-4">
          ...
          <h2 class="text-xl font-bold text-primary">3. Get Bids</h2>
        </div>
        <div class="text-[17px] text-gray-700 space-y-1 pl-2">
          <p>Nearby workers apply with bids.</p>
          <p>Check their profiles, ratings & experience.</p>
        </div>
        <p class="text-sm italic text-primary font-semibold text-right mt-4">Compare smartly.</p>
      </div>
      ...
      <div class="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition duration-300 p-6 flex flex-col justify-between h-[230px]" data-aos="fade-up" data-aos-delay="300">
        <div class="flex items-center gap-4 mb-4">
          ...
          <h2 class="text-xl font-bold text-primary">4. Select Worker</h2>
        </div>
        <div class="text-[17px] text-gray-700 space-y-1 pl-2">
          <p>Choose the best fit from bids received.</p>
          <p>Connect via chat, call, or voice message.</p>
        </div>
        <p class="text-sm italic text-primary font-semibold text-right mt-4">Choose wisely.</p>
      </div>
      ...
      <div class="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition duration-300 p-6 flex flex-col justify-between h-[230px]" data-aos="fade-up" data-aos-delay="400">
        <div class="flex items-center gap-4 mb-4">
          ...
          <h2 class="text-xl font-bold text-primary">5. Work Begins</h2>
        </div>
        <div class="text-[17px] text-gray-700 space-y-1 pl-2">
          <p>Worker arrives and completes the job.</p>
          <p>Monitor and assist if needed.</p>
        </div>
        <p class="text-sm italic text-primary font-semibold text-right mt-4">Stay informed.</p>
      </div>
      ...
      <div class="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition duration-300 p-6 flex flex-col justify-between h-[230px]" data-aos="fade-up" data-aos-delay="500">
        <div class="flex items-center gap-4 mb-4">
          ...
          <h2 class="text-xl font-bold text-primary">6. Rate & Review</h2>
        </div>
        <div class="text-[17px] text-gray-700 space-y-1 pl-2">
          <p>Leave a rating after the job is done.</p>
          <p>Help workers grow and improve.</p>
        </div>
        <p class="text-sm italic text-primary font-semibold text-right mt-4">Your feedback matters.</p>
      </div>
